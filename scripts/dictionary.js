var dictionary = (function () {
    var dicWordDefinition = {
            ...
            'с': {
                ...
                'станиоль': 'Тончайший лист олова или сплава его со свинцом, оловянная фольга. На оборотной стороне зеркала накладывается станиоль.',
        ...
        dicWordVariants = {
            'национальность': ['аил', 'али', 'инь', 'иол', 'ион', 'лао', 'лат', 'лис', 'лит', 'лот', 'нас', 'нит', 'ноа', 'ноо', 'нос', 'оса', 'ост', 'ось', 'сан', 'сон', 'таи', 'тан', 'тао', 'тис', 'тол', 'тон', 'аист', 'алан', 'алас', 'альт', 'анис', 'аноа', 'илот', 'лань', 'ласт', 'лино', 'линт', 'линь', 'лиса', 'лист', 'лицо', 'лоно', 'лось', 'лото', 'наос', 'наст', 'нить', 'нота', 'осот', 'ость', 'сало', 'сани', 'сила', 'синь', 'сито', 'слон', 'соло', 'соль', 'сонь', 'сота', 'соти', 'стан', 'стол', 'стон', 'таль', 'тиас', 'тина', 'тиол', 'толь', 'тоса', 'цата', 'циан', 'анион', 'аннат', 'анонс', 'асцит', 'атлас', 'ионол', 'лиана', 'лотос', 'нанос', 'нилот', 'нотис', 'оолит', 'ооцит', 'осина', 'остол', 'салат', 'салон', 'сатин', 'сиаль', 'силан', 'силон', 'слань', 'сталь', 'стило', 'стиль', 'талон', 'танин', 'толос', 'тонна', 'циста', 'аланин', 'аннона', 'ланита', 'лантан', 'лосина', 'лосьон', 'настил', 'нацист', 'осанна', 'сальто', 'солано', 'сонант', 'соната', 'стлань', 'столон', 'талион', 'тиноль', 'тонина', 'цианат', 'нотница', 'онанист', 'ооциста', 'соланин', 'солитон', 'станина', 'станица', 'станнин', 'столица', 'анналист', 'антоциан', 'сантонин', 'солонина', 'сонатина', 'станиоль', 'сантолина'],
            'родина': ['аир', 'дан', 'дао', 'дар', 'дно', 'идо', 'иод', 'ион', 'ноа', 'ода', 'рад', 'род', 'анид', 'анод', 'дари', 'дина', 'дорн', 'дрон', 'ирод', 'нард', 'нора', 'норд', 'орда', 'рани', 'адрон', 'данио', 'динар', 'надир', 'народ', 'радио', 'радон'],
    ...
    return {
        ...
        checkExistance: function (userWord, levelWord) {
            ...
            if (variants.indexOf(userWord) != -1) {
                return true;
            } else {
                return false;
            }
